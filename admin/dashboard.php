   ...
   <section class="dashboard">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <p>Tổng</p>
            <a href="placed_orders.php" class="btn">Xem đơn đã đặt</a>
         </div>
         ...
         <div class="box">
            ...
            <p>Tổng</p>
            <a href="placed_orders.php" class="btn">Xem đơn đã hoàn thành</a>
         </div>
         ...
         <div class="box">
            ...
            <p>Thêm món</p>
            <a href="products.php" class="btn">Món ăn</a>
         </div>
         ...
         <div class="box">
            ...
            <a href="admin_accounts.php" class="btn">Xem quản lý</a>
         </div>
