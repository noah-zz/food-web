...
<body>
   ...
   <div class="heading">
      <h3>checkout</h3>
      <p><a href="home.php">Trang chủ</a> <span> / checkout</span></p>
   </div>
   ...
   <section class="checkout">
      ...
      <form action="" method="post">
         ...
         <div class="cart-items">
            ...
            if ($select_cart->rowCount() > 0) {
               while ($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  ?>
                  <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price">VNĐ <?= $fetch_cart['price']; ?>
                        x
            ...
            ?>
            <p class="grand-total"><span class="name">Tổng :</span><span class="price"> VNĐ<?= $grand_total; ?></span>
            </p>
         ...
         <div class="user-info">
            ...
            <a href="update_profile.php" class="btn">Cập nhập </a>
            <h3>Địa chỉ </h3>
            ...
            <select name="method" class="box" required>
               ...
               <option value="paypal">Qr pay</option>
            </select>
